...
{{% notice warning %}}
Không nên sử dụng S3 One Zone-IA cho bản sao duy nhất của dữ liệu quan trọng nếu hệ thống yêu cầu khả năng phục hồi trên nhiều Availability Zone.
{{% /notice %}}
...
{{% notice warning %}}
Đoạn Terraform trên chỉ mang tính minh họa. Cần kiểm tra phiên bản AWS Provider, giới hạn chuyển đổi giữa các Storage Class và yêu cầu lưu giữ dữ liệu trước khi áp dụng vào hệ thống thực tế.
{{% /notice %}}
